...
const Footer = () => {
  return (
    ...
    <img src="/assets/imgs/bg-shape-6.svg" alt="Shape" className="animation-slide-right bg-shape" />
          ...
          <div className="left-content">
            ...
            <div className="footer-clients d-flex align-items-center">
              <div className="footer-client-img">
                <img src="/assets/imgs/youtube-2.svg" alt="Youtube" />
              </div>
              <div className="footer-client-img">
                <img src="/assets/imgs/webflow-2.svg" alt="webflow" />
              </div>
              <div className="footer-client-img">
                <img src="/assets/imgs/zoom.svg" alt="upwork" />
              </div>
              <div className="footer-client-img">
                <img src="/assets/imgs/shopify-2.svg" alt="shopify" />
              </div>
            </div>
          </div>
